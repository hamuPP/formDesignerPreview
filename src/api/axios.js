...
axios.interceptors.request.use((config) => {
    ...
    // config.headers['Content-Type'] = config.headers['My-Content-Type'] || 'application/x-www-form-urlencoded; charset=UTF-8';
    // if(sessionStorage.getItem('access_token'))config.headers['Authorization'] = 'Bearer '+ sessionStorage.getItem('access_token');
