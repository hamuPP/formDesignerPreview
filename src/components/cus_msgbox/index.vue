<template>
  <transition name="msgbox-fade">
    <div
           ...
           >
      <div class="el-message-box cus-msgbox-box"
        ...
        <div class="el-message-box__content">
          <div class="el-message-box__container">
            ...
            <div class="el-message-box__message" v-if="message !== ''">
              ...
              <span v-if="subMessage" class="cus-msgbox-box__sub-message">{{subMessage}}</span>
        ...
        <div class="el-message-box__btns" v-show="confirmButtonText || cancelButtonText">
          <cus-button ref="confirm"
                      v-show="confirmButtonText"
                      size="medium"
                      fill-primary border
                      @click.native="handleAction('confirm')"
                      @keydown.enter="handleAction('confirm')">{{confirmButtonText}}</cus-button>
          <cus-button
                  v-show="cancelButtonText"
                  size="medium"
                  primary border
                      @click.native="handleAction('cancel')"
                      @keydown.enter="handleAction('cancel')">{{cancelButtonText}}</cus-button>
<!--          <el-button-->
